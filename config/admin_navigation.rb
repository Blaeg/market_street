SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :user_tab ,"Customer", '#' do |user|
    ...
    primary.item :inventory_tab, 'Inventory', '#' do |inventory|
    ...
    primary.item :offer_tab ,"Offer", '#' do |offer|        
    ...
    primary.item :orders_tab, 'Order', '#' do |order|
    ...
    if current_user.super_admin?
      primary.item :config_tab ,"Config", '#' do |config|        
