class Admin::Catalog::Wizards::BaseController < Admin::BaseController
...
private
  def next_form
    if next_wizard_form
      ...
      new_admin_catalog_wizards_product_url
    end
  end
